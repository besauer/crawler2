...
5. Zurück auf der Seite „Suche“ die gewünschten Schulen per Checkbox auswählen (Alle/Keine sowie Feldfilter „Wert enthält …“ stehen als Hilfen zur Verfügung). Sobald ein Filter angewendet wird, blendet die Tabelle automatisch alle nicht passenden Schulen aus und markiert die verbleibenden Datensätze vor. Anschließend die Stichwörter (ein Suchbegriff pro Zeile) eintragen.
6. Neben jedem Suchbegriff steht der Link „Suchbegriff erweitern“. Ein Klick öffnet ein Dialogfenster mit dem aktuell verwendeten Prompt, der sich vor dem Absenden anpassen lässt. Nach dem Absenden werden alle von der KI vorgeschlagenen Synonyme automatisch unter dem jeweiligen Begriff übernommen; dort können sie einzeln entfernt oder durch eigene Ergänzungen erweitert werden – nur die sichtbaren Einträge werden später durchsucht.
